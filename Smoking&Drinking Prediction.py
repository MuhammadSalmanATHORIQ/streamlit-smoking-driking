...
if st.button('Cek Analisis sinyal tubuh Klasifikasi perokok'):
    predict = model.predict(
        [[sex, age, height, weight, waistline, sight_left, sight_right, hear_left, hear_right, SBP, DBP, HDL_chole, LDL_chole, triglyceride, hemoglobin, urine_protein, serum_creatinine, SGOT_AST, SGOT_ALT, gamma_GTP, SMK_stat_type_cd]]
    )
